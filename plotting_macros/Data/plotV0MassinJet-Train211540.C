...
void plotV0Mass(string hadron, double jetptmin = 10., double jetptmax = 1e3, double zmin = 0., double zmax = 1.+1e-3)
{
  ...
  TFile *inFile = TFile::Open(TString::Format("%s", inName.c_str()).Data());
  THnSparseD* thn0 = (THnSparseD*)inFile->Get(histName.c_str());
  thn0->Sumw2();

  TFile* f1 = new TFile("~/Documents/TrainOutput/211540/449460.root");
  THnSparseD* thn1 = (THnSparseD*)f1->Get(histName.c_str());
  TFile* f2 = new TFile("~/Documents/TrainOutput/211540/449462.root");
  THnSparseD* thn2 = (THnSparseD*)f2->Get(histName.c_str());
  TFile* f3 = new TFile("~/Documents/TrainOutput/211540/449466.root");
  THnSparseD* thn3 = (THnSparseD*)f3->Get(histName.c_str());

  THnSparseD* thn = (THnSparseD*)thn0->Clone();
  thn->Add(thn1);
  thn->Add(thn2);
  thn->Add(thn3);

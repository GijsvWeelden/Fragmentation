...
void matchedV0Z(string inName = "AnalysisResults.root", string hadron = "", double partjetptmin = 10., double partjetptmax = 200.)
{
  if ("" == inName) {
    cout << "Error: inName must be specified" << endl;
    return;
...
{ matchedV0Pt(inName, "Lambda0", partjetptmin, partjetptmax); }

void matchedLambda0Z(string inName = "AnalysisResults.root", double partjetptmin = 10., double partjetptmax = 200.)
{ matchedV0Z(inName, "Lambda0", partjetptmin, partjetptmax); }
...
{ matchedV0Pt(inName, "AntiLambda0", partjetptmin, partjetptmax); }

void matchedAntiLambda0Z(string inName = "AnalysisResults.root", double partjetptmin = 10., double partjetptmax = 200.)
{ matchedV0Z(inName, "AntiLambda0", partjetptmin, partjetptmax); }

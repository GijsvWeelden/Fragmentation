...
void plotJetEnergyScale(double ptMin = 40, double ptMax = 60, string input = "LHC21k6/train109274")
{
  double time = clock();
  ...
  bool setLogY = true;
  bool setLogZ = false;
  double xMinFrame = 0, xMaxFrame = 2, yMinFrame = 1e-5, yMaxFrame = 2, zMinFrame = 1e-5, zMaxFrame = 1;

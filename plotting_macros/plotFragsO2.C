...
void plotFragsO2(void)
{
  ...
  plotJetMatchingQA(matchJetsDir, 40, 60, saveDir);
...
void plotJetMatchingQA(TDirectory* inDir, double ptMinTruth, double ptMaxTruth, string saveDir)
{
  ...
  xMinFrame = 0, xMaxFrame = 80, yMinFrame = 40, yMaxFrame = 60;
  saveName = TString::Format("%s/matchedJetPt_pt40-60", saveDir.c_str());
  plotOneHist(matchDetJetPtPartJetPt, xTitle, yTitle, histTitle, saveName,
              xMinFrame, xMaxFrame, yMinFrame, yMaxFrame,
              xMinLegend, xMaxLegend, yMinLegend, yMaxLegend,
              setLogZ, drawLegend);
  ...
  TH2F* matchDetJetEtaPartJetEta = (TH2F*)matchPartJetPtDetJetEtaPartJetEta->Project3D("zy");
  ...
  if (ptMinTruth > -900 || ptMaxTruth > -900) {
    ...
    firstBinPt = matchPartJetPtResolutionPt->GetXaxis()->FindBin(min);
    lastBinPt = matchPartJetPtResolutionPt->GetXaxis()->FindBin(max);
  }
  TH1F* jetResolutionPt = (TH1F*)matchPartJetPtResolutionPt->ProjectionY("resolution", firstBinPt, lastBinPt);
  ...
  xMinFrame = 0, xMaxFrame = 200, yMinFrame = 0, yMaxFrame = 2;
  ...
  xMinFrame = 40, xMaxFrame = 60, yMinFrame = 0, yMaxFrame = 2;
  saveName = TString::Format("%s/jetEnergyScale_pt40-60", saveDir.c_str());
  plotOneHist(jetPtEnergyScale, xTitle, yTitle, histTitle, saveName,
              xMinFrame, xMaxFrame, yMinFrame, yMaxFrame,
              xMinLegend, xMaxLegend, yMinLegend, yMaxLegend,
              setLogY, drawLegend);

{
  ...
  Char_t *fname_base="output/pythia_full_jets_5020GeV_%.0f_%.0f_all.root";
  ...
  Float_t ptjetmin = 15;
  Float_t ptjetmax = 20;
  Float_t etajetmin = -0.5;
  Float_t etajetmax = 0.5;
  ...
  for (Int_t ibin = 0; ibin < nbins; ibin++) {
    ...
    c1->cd(2);
    gPad->SetLogy();
    Int_t minetabin = hJetPtEtaPhi->GetYaxis()->FindBin(etajetmin+0.001);
    Int_t maxetabin = hJetPtEtaPhi->GetYaxis()->FindBin(etajetmax-0.001);
    ...
    Int_t minptbin = hEtaPtJetPtPion->GetYaxis()->FindBin(ptjetmin+0.0001);
    Int_t maxptbin = hEtaPtJetPtPion->GetYaxis()->FindBin(ptjetmax-0.0001);
    minetabin = hEtaPtJetPtPion->GetXaxis()->FindBin(etajetmin+0.001);
    maxetabin = hEtaPtJetPtPion->GetXaxis()->FindBin(etajetmax-0.001);

    hEtaPtJetPtPion->GetXaxis()->SetRange(minetabin, maxetabin);
    hEtaPtJetPtPion->GetYaxis()->SetRange(minptbin, maxptbin);
    hpy = hEtaPtJetPtPion->Project3D(Form("z_pion_%d",ibin));
    if (do_scaling) {
      hpy->Sumw2();
      hpy->Scale(scale);
    }
    ...
    hEtaPtJetPtKaon->GetXaxis()->SetRange(minetabin, maxetabin);
    hEtaPtJetPtKaon->GetYaxis()->SetRange(minptbin, maxptbin);
    hpy = hEtaPtJetPtKaon->Project3D(Form("z_kaon_%d",ibin));
    if (do_scaling) {
      hpy->Sumw2();
      hpy->Scale(scale);
    }
    ...
    hEtaPtJetPtProton->GetXaxis()->SetRange(minetabin, maxetabin);
    hEtaPtJetPtProton->GetYaxis()->SetRange(minptbin, maxptbin);
    hpy = hEtaPtJetPtProton->Project3D(Form("z_proton_%d",ibin));
    if (do_scaling) {
      hpy->Sumw2();
      hpy->Scale(scale);
    }
    ...
    hEtaPtJetPtD->GetXaxis()->SetRange(minetabin, maxetabin);
    hEtaPtJetPtD->GetYaxis()->SetRange(minptbin, maxptbin);
    hpy = hEtaPtJetPtD->Project3D(Form("z_dzero_%d",ibin));
    if (do_scaling) {
      hpy->Sumw2();
      hpy->Scale(scale);
    }
    ...
    hEtaPtJetZD->GetXaxis()->SetRange(minetabin, maxetabin);
    hEtaPtJetZD->GetYaxis()->SetRange(minptbin, maxptbin);
    hpy = hEtaPtJetZD->Project3D(Form("z_dzero_z_%d",ibin));
    if (do_scaling) {
      hpy->Sumw2();
      hpy->Scale(scale);
    }
